...
export function SocialPanel({ onBack, onLocationSelect }: SocialPanelProps) {
  ...
  const [socialFeed, setSocialFeed] = useState<SocialPost[]>([
    ...
    {
      id: '2',
      user: { name: 'Mike Johnson', avatar: 'MJ', level: 'Road Master' },
      type: 'photo',
      content: 'Amazing view from the Golden Gate Bridge!',
    ...
    {
      id: '3',
      user: { name: 'Lisa Park', avatar: 'LP', level: 'Local Guide' },
      type: 'review',
      content: 'Excellent service and authentic Italian food. The pasta was perfectly cooked!',
      location: 'Nonna\'s Kitchen, North Beach',
  ...
  // Scroll management
  const scrollToTop = () => {
    const currentRef = activeTab === 'feed' ? feedRef : 
                      activeTab === 'incidents' ? incidentsRef : leaderboardRef;
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      if (currentRef.current) {
        setShowTop(currentRef.current.scrollTop > 200);
      }
    };

    const refElement = currentRef.current;
    if (refElement) {
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="flex-1 flex flex-col">
        ...
        <div className="flex-1 overflow-hidden">
          ...
          <TabsContent
            value="feed"
            ref={feedRef}
            className="h-full scroll-y hide-scrollbar scroll-smooth p-4 mt-0"
          >
                ...
                <Card key={post.id} className="p-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {post.photos && (
                        <div className="mb-3">
                          <div className="w-full h-32 bg-gradient-to-br from-orange-400 to-pink-400 rounded-lg"></div>
                        </div>
                      )}
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <Button
                          ...
                          onClick={async () => {
                            ...
                            else if (navigator.clipboard) { await navigator.clipboard.writeText(shareData.url); alert('Link copied'); }
                          }}
                        >
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex items-center justify-between">
                        <div className="text-sm text-gray-500">
                          Reported by {incident.reporter} • {incident.confirmations} confirmations
                        </div>
        ...
        <DialogContent>
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-end gap-2">
              <Button variant="ghost" onClick={() => setPhotoOpen(false)}>Cancel</Button>
              <Button onClick={() => {
                ...
                setPhotoCaption(''); setPhotoUrl(null); setPhotoOpen(false);
              }}>Post</Button>
            </div>
          </div>
        </DialogContent>
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button onClick={() => {
                ...
                setReportLocation(''); setReportDescription(''); setReportType('traffic'); setReportOpen(false);
              }}>Submit</Button>
            </div>
          </div>
        </DialogContent>
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button onClick={() => {
                ...
                setCheckinLocation(''); setCheckinOpen(false);
              }}>Check In</Button>
            </div>
          </div>
        </DialogContent>
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-end gap-2">
              ...
              <Button onClick={() => {
                ...
                setReviewPlace(''); setReviewText(''); setReviewRating(5); setReviewOpen(false);
              }}>Post Review</Button>
            </div>
          </div>
        </DialogContent>
