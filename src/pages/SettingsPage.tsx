...
export default function SettingsPage({ onNavigateBack, isFullscreen = false, ...props }: SettingsPageProps) {
  return (
    <div className={`${isFullscreen ? 'h-screen' : 'h-full'} bg-white flex flex-col`}>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="text-center max-w-md">
          ...
          <h1 className="text-2xl font-bold mb-2">SettingsPage</h1>
          <p className="text-gray-600 mb-6">
            This is a web-compatible placeholder for the SettingsPage component.
          </p>
